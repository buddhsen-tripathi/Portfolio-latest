...
export const experiences = [
  ...
  },
  {
    ...
    responsibility: [
      ...
      [
        { text: "Engineered an " },
        { text: "in-house persistent memory infrastructure", bold: true },
        { text: " for jewelry design taste  a " },
        { text: "RAG-based retrieval system", bold: true },
        { text: " backed by " },
        { text: "user-scoped vector embeddings", bold: true },
        { text: " that continuously indexed preference signals across sessions. Each generation fed back into a " },
        { text: "rolling context window", bold: true },
        { text: ", enabling the system to learn and refine " },
        { text: "personalized design taste", bold: true },
        { text: " over time while suppressing duplicate outputs. Optimized " },
        { text: "embedding retrieval latency to sub-80ms", bold: true },
        { text: " via " },
        { text: "ANN search", bold: true },
        { text: " over a " },
        { text: "Milvus", bold: true },
        { text: " collection, keeping memory lookups invisible to the user within the generation pipeline." },
      ],
      [
